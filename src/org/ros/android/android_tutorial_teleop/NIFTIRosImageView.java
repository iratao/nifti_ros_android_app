 ...
 */
public class NIFTIRosImageView<T> extends ImageView implements NodeMain {
  ...
  public NIFTIRosImageView(Context context) {
    super(context);
  ...
  public NIFTIRosImageView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public NIFTIRosImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    subscriber.addMessageListener(new MessageListener<T>() {
      ...
      public void onNewMessage(final T message) {
        post(new Runnable() {
          @Override
          public void run() {
        	tempImage = callable.call(message);
            setImageBitmap(tempImage);
  ...
  // Call to get the current camera snapshot
