 ...
 */
public class NIFTIOccupancyGridLayer extends SubscriberLayer<nav_msgs.OccupancyGrid> implements TfLayer {
  ...
  public NIFTIOccupancyGridLayer(String topic) {
    this(GraphName.of(topic));
  }

  public NIFTIOccupancyGridLayer(GraphName topic) {
